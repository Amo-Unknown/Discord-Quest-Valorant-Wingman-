...
ابتدا برنامه **Vencord** را دانلود کرده و به فعال کردن Enable Developer React در تنظیمات نیاز هستش

1) اول از همه وارد بخش **Gift Inventory** میشید و کوئست رو اکسپت میکنید
3) وارد یک **ویس** بشید / و یک یوزر دیگر هم وارد همون ویس که جوین شدید ، جوین بشید
4) یک صفحه دلخواه رو استریم کنید **(سعی کنید از اسکرین 1 استفاده نکنید)**
5) Ctrl + Shift + i رو فشار دهید تا وارد کنسول بشی
6) بعد از وارد شدن در کنسول /allow pasting را وارد کنید
7) سپس این کد رو پیست کنید
